...
class AlamofireRequestBuilder<T>: RequestBuilder<T> {
    ...
    /**
     ...
     configuration.
     */
    func createSessionManager() -> Alamofire.SessionManager {
     ...
     */
    func makeRequest(manager: SessionManager, method: HTTPMethod, encoding: ParameterEncoding, headers: [String:String]) -> DataRequest {
...
enum AlamofireDecodableRequestBuilderError: Error {
...
class AlamofireDecodableRequestBuilder<T:Decodable>: AlamofireRequestBuilder<T> {
