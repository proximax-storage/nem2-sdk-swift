...
public class Hashes {
     ...
     *
     * - parameter inputs: The byte arrays to hash.
     * - returns: The hash of the inputs.
     */
    public static func sha3_256(_ inputs: [UInt8]) -> [UInt8] {
        return Data(bytes: inputs).sha3(.sha256).bytes
    }
    ...
    public static func sha3_512(_ inputs: [UInt8]) -> [UInt8] {
        return Data(bytes: inputs).sha3(.sha512).bytes
    }
    ...
    public static func ripemd160(_ inputs: [UInt8]) -> [UInt8] {
        var hash = RIPEMD160()
        hash.update(data: Data(bytes: inputs))
        return hash.finalize().bytes
    }
}
